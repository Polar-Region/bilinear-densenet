...
class BilinearEfficientnetB0(nn.Module):
    def __init__(self, num_classes, attention=None, fc="fc"):
        super().__init__()
        # 使用EfficientNet b0的features部分作为卷积层
        self.conv = models.efficientnet_b0(weights=models.EfficientNet_B0_Weights.DEFAULT if fc else None).features
        # 定义注意力机制层
